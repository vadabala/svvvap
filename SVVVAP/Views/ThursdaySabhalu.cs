...
{
    public class ThursdaySabhalu : ContentPage
    {

        public ThursdaySabhalu()
        {

			Title = "Thursday Sabhalu";
            BackgroundColor = Color.White;

            var youtubeViewModel = new ThursdaySabhaluVM();

            BindingContext = youtubeViewModel;

			var headerlabel = new StackLayout
			{
				Padding = new Thickness(0, 15, 0, 0),
				Children = 
				{
					new Label {Text = "GuruSpeech: Thursday Sabhalu",
